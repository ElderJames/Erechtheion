...
namespace DNIC.Erechtheion.Core.RepositoryBase
{
	...
	public interface IEntityRepository<T, TPrimaryKey> : IDisposable where T : PlainEntity<TPrimaryKey>
	{
		//Single部分
		...
		T SingleOrDefault(TPrimaryKey id);
		#endregion
		...
		/// <exception cref="ArgumentNullException">Id为空</exception>
		TSub SingleOrDefault<TSub>(TPrimaryKey id) where TSub : T;
		#endregion
		...
		/// <exception cref="ArgumentNullException">Id为空</exception>
		/// <exception cref="NullReferenceException">无该对象</exception>
		TSub Single<TSub>(TPrimaryKey id) where TSub : T;
		#endregion
		...
		/// <remarks>IDictionary[TPrimaryKey, T]，[Id, 实体对象]</remarks>
		IDictionary<TPrimaryKey, T> Find(IEnumerable<TPrimaryKey> ids);
		#endregion
		...
		IDictionary<TPrimaryKey, TSub> Find<TSub>(IEnumerable<TPrimaryKey> ids) where TSub : T;
		#endregion
		...
		/// <returns>是否存在</returns>
		/// <exception cref="ArgumentNullException">Id为空</exception>
		bool Exists<TSub>(TPrimaryKey id) where TSub : T;
		#endregion
